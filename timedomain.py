...
def compute_features(content, style, input_features, norm=False, stride=1, n_layers=1, n_filters=4096, n_fft=1024, kernel_height=1, kernel_width=11):
    ...
    with g.as_default(), g.device('/cpu:0'), tf.compat.v1.Session() as sess:
        ...
        # print('compute features ', 'content feature: ', content_feature, 'style feature: ', style_feature, 'style gram: ', style_gram, end='\r')
        ...
        for layer_i in range(n_layers):
            ...
            # print('compute features ', 'layer: ', layer_i, 'content feature: ', content_feature, 'style feature: ', style_feature, 'style gram: ', style_gram, end='\r')
